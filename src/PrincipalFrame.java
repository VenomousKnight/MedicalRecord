...
public class PrincipalFrame extends JFrame {
	...
	public PrincipalFrame() {
		...
		// Initialize the add patient menu item and required listener to open
		// AddPatientFrame frame.
		...
		// Initialize the modify patient menu item and required listener to open
		// ModifyPatientFrame frame.
			...
			public void actionPerformed(ActionEvent e) {
				...
				do {
					try {
						...
						// If the modify frame was not initialize, the program will initialized it with
						// the ssn that the user enters.
						if (modifyPatientFrame == null && ssn != null) {
							modifyPatientFrame = new ModifyPatientFrame(ssn);
						}

						// If the modify frame was initialized, the program initialized it again with
						// the new ssn entered by the user.
						if (modifyPatientFrame != null && ssn != null) {
						...
						JOptionPane.showMessageDialog(contentPane, "You must enter a valid social security number",
						...
						JOptionPane.showMessageDialog(contentPane, "The record you are looking for does not exist.",
								"Error", JOptionPane.ERROR_MESSAGE);
		...
		// Initialize the search patient menu item and required listener to open
		// SearchPatientFrame frame.
			...
			public void actionPerformed(ActionEvent e) {
				...
				do {
					...
					try {
						...
						// If the search frame was not initialize, the program will initialized it with
						// the ssn that the user enters.
						if (searchPatientFrame == null && ssn != null) {
							searchPatientFrame = new SearchPatientFrame(ssn);
						}

						// If the search frame was initialized, the program initialized it again with
						// the new ssn entered by the user.
						if (searchPatientFrame != null && ssn != null) {
		...
		// Initialize the display all patient menu item and required listener to open
		// DisplayAllPatientFrame frame.
		...
		// Initialize exit menu item and the required listener to close the program when
		// it was pressed.
		...
		// Initialize the help content menu item and required listener to open
		// HelpContentsFrame frame.
		...
		// Initialize the about menu item and required listener to open AboutFrame
		// frame.
		...
		JLabel title = new JLabel("Health and Care hospital");
		JLabel logoLabel = new JLabel("");// , new ImageIcon(getClass().getResource("Logo.jpeg")), JLabel.CENTER);
		// logoLabel.setBounds(0, 0, 783, 480);
